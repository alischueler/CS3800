...
public class xml {
    ...
    //id to name
    public static HashMap<String, String> idName;
    ...
    public static void main(String[] args) {
        ...
        List<String> toPrint = callParse("", "states");
