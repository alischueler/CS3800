...
public class NFAUnion {
    ...
    public static void main(String[] args) {
        ...
        String newFinal = findNewFinal(statesOne.get(2), statesTwo.get(2));
        ...
        NFA newDFA = new NFAMaker(newStates, newTrans, newMap);
        NFAXML NFAXML = new NFAXML();
        List<String> output = NFAXML.createXML(newDFA, true);
        for (String s : output) {
    ...
    public static List<String> combineTrans(String newStates, String oldOneStart, String oldTwoStart,
        ...
        for (int i = 0; i < newArr.length; i++) {
            ...
            if (curr.contains(".1")) {
                ...
                LinkedHashMap<String, LinkedHashSet<String>> toReplace = one.get(getID(og, oneIdName));
                updateInfo(toReplace, oneIdName, true);
                updateInfo(toReplace, oldtoNewOne, false);
                update.replace(curr, toReplace);
            } else if (newArr[i].contains(".2")) {
