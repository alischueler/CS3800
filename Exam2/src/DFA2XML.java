...
//    }
    ...
    public static List<String> createXML(DFA fig) {
        ...
        List<State> allStates2 = fig.getStates();
        for (int i = 0; i < numStates; i++) {
            StringBuilder toAdd = new StringBuilder();
            State curr = allStates2.get(i);
            toAdd.append("<state id=\"");
            toAdd.append(curr.getId());
            toAdd.append("\" name=\"");
            toAdd.append(curr.getName());
            toAdd.append("\">");
        ...
        List<DFATransition> delta = fig.getDelta();
        for (DFATransition t : delta){
            String start = t.getFrom();
            String end = t.getTo();
