 ...
 */
public class DFA14 implements DFA {
    static HashSet<String> states;
    static HashSet<String> alphabet;
    static LinkedHashMap<String, LinkedHashMap<String, String>> delta;
    static String start;
    ...
    public static HashMap<String, String> setUpIdName() {
        HashMap<String, String> idName = new HashMap<String, String>(states.size());
        String[] sArr = states.toArray(new String[states.size()]);
        for (int i=0; i<states.size();i++) {
            idName.put(sArr[i], sArr[i]);
        }
        return idName;
    }
     ...
     */
    private static LinkedHashMap<String, LinkedHashMap<String, String>> setUpDelta() {
        String[] sArr = states.toArray(new String[states.size()]);
        String[] symArr = alphabet.toArray(new String[alphabet.size()]);
        LinkedHashMap<String, String> one = new LinkedHashMap<String, String>(1);
        LinkedHashMap<String, String> two = new LinkedHashMap<String, String>(1);
        LinkedHashMap<String, String> three = new LinkedHashMap<String, String>(1);
        ...
        LinkedHashMap<String, LinkedHashMap<String, String>> ret = new LinkedHashMap<String, LinkedHashMap<String, String>>();
        ret.put(sArr[0], one);
        ret.put(sArr[1], two);
     ...
     */
    private static List<String> convertTransition(LinkedHashMap<String, LinkedHashMap<String, String>> delta) {
        List<String> ret = new ArrayList<>();
        Iterator<Map.Entry<String, LinkedHashMap<String, String>>> it = delta.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<String,LinkedHashMap<String, String>> en = it.next();
